	...
	<div class="oz-form">
		<div class="oz-form-container container">
			<div id="msc">
				...
				<div class="form-data">
					<?php echo'<form action="'.phd($conn).'" ent-type="form-data" method="POST" id="form">';
			...
			<div class="validated" id="Login" name="validated" title="Login" ><a href="phd.php">Not Registered?</a></div>
		</div>
	</div>
