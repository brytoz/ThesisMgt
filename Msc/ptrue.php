...
<head>
	...
	<title>FUTO POSTGRADUATE | Msc STUDENT</title>
...
<body >
	...
	<div class="oz-form-profile">
			<div class="oz-body-main" id="oz-body-main">
				<div class="oz-body">
					...
					<a onclick="actionTwo()" href="#" name="process"> <span><i class="fa fa-mortar-board"></i></span> Process </a>
				...
				<div class="oz-details" id="disappear1">
					<?php require_once 'all.php';
						echo '<p><span class="oz-detailed">FULLNAME:</span> '.$fullname.'</p>';
	...
	<br>
	<div class="footer"> designed and developed by <a href="#" title="OWNED BY BRYTOZ" target="_blank">GROUP 4</a></div>
	<script src="../main.js"></script>
</body>
</html>
