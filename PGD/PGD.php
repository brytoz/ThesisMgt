...
<head>
	...
	<title>FUTO POSTGRADUATE | PGD STUDENTs REGISTRATION</title>
...
<body onload="load()">
	<div class="oz-sticky-nav" id="oz-sticky-nav">
		<a  href="#"  class="oz-categories Category active" id="oz-categories Category">PGD students<i class="fa fa-cogs"></i></a>
		...
		<div class="oz-form-container container">
			<div id="pgd">
				...
				<div class="form-data"><?php
						echo '<form action="'.pgd($conn).'" ent-type="form-data" method="POST" id="form">';
			...
			<div class="validated" id="Login" name="validated" title="Login" >Registered?, <a cursor="pointer" href="<?php echo 'login.php?=login20912?/postgraduate'; ?>">Login!	</a></div>
			</div>
		</div>
	</div>
